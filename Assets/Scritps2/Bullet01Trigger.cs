...
public class Bullet01Trigger : MonoBehaviour
{
     ...
     void OnTriggerEnter(Collider other)
    {
        ...
        if (other.tag == "Enemy")
        {
            ...
            if (tower.GetComponent<TowerStat>().AttackCont == 1)
            {
            other.GetComponent<EnemyStat>().DamageTrigger(tower,tower.GetComponent<TowerStat>().DamageF(),100f);
            }
            else
            {
