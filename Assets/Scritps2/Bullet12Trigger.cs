...
public class Bullet12Trigger : MonoBehaviour
{
     ...
     void OnTriggerEnter(Collider other)
    {
        ...
        if (other.tag == "Enemy")
        {
            ...
            if (tower.GetComponent<TowerStat>().attackcon(2))
            {
            other.GetComponent<EnemyStat>().DamageTrigger(tower,tower.GetComponent<TowerStat>().DamageF(), tower.GetComponent<TowerStat>().DoubleAtPerF());
