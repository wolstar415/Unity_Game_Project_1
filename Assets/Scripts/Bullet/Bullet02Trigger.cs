...
public class Bullet_Trigger_Effect : MonoBehaviour
{
    ...
    void Update() // 매 프레임마다 실행되는 함수입니다.
    {
        ...
        if (bulletState.Target != null && bulletState.Target.activeSelf==true)
        {
     ...
     void OnTriggerEnter(Collider other)
    {
        ...
        if (other.tag == "Enemy")
        {
            ...
            GameObject Effect01 = Instantiate(Effect, other.transform.position + new Vector3(0f, 1f, 0f), other.transform.rotation);
